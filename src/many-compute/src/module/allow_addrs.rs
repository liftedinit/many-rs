...
use many_modules::{compute, ManyModule, ManyModuleInfo};
use many_protocol::{RequestMessage, ResponseMessage};
use std::collections::BTreeSet;
use std::fmt::{Debug, Formatter};

pub struct AllowAddrsModule<T: compute::ComputeModuleBackend> {
    pub inner: compute::ComputeModule<T>,
    pub allow_addrs: BTreeSet<Address>,
}

impl<T: compute::ComputeModuleBackend> Debug for AllowAddrsModule<T> {
...
impl<T: compute::ComputeModuleBackend> ManyModule for AllowAddrsModule<T> {
