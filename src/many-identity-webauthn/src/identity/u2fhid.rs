//! This is a copy of the webauthn-authenticator-rs u2fhid implementation,
//! with a difference in the API; the perform_auth function returns a
//! PublicKeyCredentials which has no rawId in it, as the Ledger Nano
//! doesn't have proper CTAP 2.1 support (notably the attestation object
//! is missing).
