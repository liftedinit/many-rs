...
@test "$SUITE: Update is consistent" {
  ...
  call_web --pem=1 --port=8000 update test_dweb test_dweb.zip --site-description foobar
  assert_output --partial 'https://test_dweb-'$(identity 1)'.ghostcloud.org'
  assert_output --partial 'foobar'
  check_consistency --pem=1 --value=test_dweb 8000 8001 8002 8003
  check_consistency --pem=1 --value=foobar 8000 8001 8002 8003
}
